...
- **Domain:** `azure_speech`
- **Title:** Azure Speech
- **Repository:** pantherale0/ha-azurespeech

**Key directories:**

- `custom_components/azure_speech/` - Main integration code
...
- Integration logs: `custom_components.azure_speech: debug` in `config/configuration.yaml`
...
- Use the domain `azure_speech` for all DOMAIN references
...
- `tests/` mirrors `custom_components/azure_speech/` structure
